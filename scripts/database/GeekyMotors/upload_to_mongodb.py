...
COLLECTION = 'geeky_motors' # Nombre de la coleccion
...
FILE_PATH = os.path.join('data','raw','GeekyMotors','geeky_motors2.csv')
...
for index, row in df.iterrows():
    document = {
        "Nombre": row['Nombre'],
        "Carrocería": row["Carrocería"],
        "Tracción": row["Tracción"],
